namespace Touch {
	partial class AboutBox {
		...
		private void InitializeComponent() {
			...
			this.labelProductName.Text = "Touch";
			...
			this.labelCopyright.Text = "Copyright Gene M. Angelo, Jr.";
			...
			this.labelCompanyName.Text = "GMA Consulting Services";
			...
			this.textBoxDescription.Text = "Changes Modified Date to the current date/time for files contained in specified f" +
				 "older.  Recursion can be performed for all fines within all subdirectories.";
			// 
			// okButton
			// 
